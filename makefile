...
DEFINES = -DTAC08_PLATFORM=desktop
...
$(EXE): bin/main.o bin/hal_core.o bin/hal_audio.o bin/pico_core.o bin/pico_audio.o bin/pico_memory.o bin/pico_data.o bin/pico_script.o bin/pico_cart.o bin/utf8-util.o bin/utils.o bin/log.o bin/crypt.o
	$(CXX) $^ $(LDFLAGS) -o $@
...
bin/hal_core.o: src/hal_core.cpp src/hal_core.h src/config.h src/log.h src/crypt.h
	$(CXX) $(CXXFLAGS) $< -o $@
